...
const initializeLocalStorage = (
  ...
  updateFunc: {
    (variableName: string, value: boolean): void;
  }
) => {
...
export const useInitInfo = () => {
  ...
  useEffect(() => {
    initializeLocalStorage(SETTING_EDUCATION_MODE, true, updateVariableInLocalStorage);
    initializeLocalStorage(SETTING_DISABLE_SOUNDS, true, updateVariableInLocalStorage);
    initializeLocalStorage(SETTING_DISABLE_MUSIC, false, updateVariableInLocalStorage);
    initializeLocalStorage(SETTING_INVERT_DIRECTION, false, updateVariableInLocalStorage);
    initializeLocalStorage(SETTING_START_SCREEN, true, updateVariableInLocalStorage);
